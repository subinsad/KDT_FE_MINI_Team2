...
export default function EventBox() {
    return (
        <div className="w-72 sticky top-[116px] h-[608px] p-4 mb-4 rounded-xl border-gray-200 border-solid border-2 flex flex-col items-center">
            <div className="w-full  rounded-xl border-gray-200 border-solid border-2">
                <img src={event} alt="event이미지" />
            </div>
            ...
            <div className="pt-3 leading-5 text-sm">
                ...
                <li>
                    오전 이상, 우리 (일 90명), 롯데 (일 290명), 하나 (일 130명)
                </li>
            </div>
        </div>
    );
