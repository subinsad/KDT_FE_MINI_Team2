  ...
  return (
    <div className="w-80 p-4 rounded-xl border-gray-200 border-solid border-2 flex flex-col items-center">
      ...
      <div className="leading-6">
        <h2 className="py-5 font-bold text-2xl">결제 혜택</h2>

        <h3 className="pb-3 font-bold text-lg">토스페이</h3>
        <li>3만원 이상, 10% 최대 1만원 할인(오전 10시, 일 400명)</li>
        <li>2만원 이상, 2천원 할인 (오후 4시, 일 1,700명)</li>
      </div>

      <div className="pt-5 leading-6">
        <h3 className="pb-3 font-bold text-lg">카카오페이</h3>
        <li>3만원 이상, 10% 최대 1만원 할인(오전 10시, 일 400명)</li>
        <li>2만원 이상, 2천원 할인 (오후 4시, 일 1,700명)</li>
      </div>

      <div className="pt-5 leading-6">
        <h3 className="pb-3 font-bold text-lg">신용/체크카드</h3>
