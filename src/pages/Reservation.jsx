...
export default function Reservation() {
    ...
    const handleAllOptionsChange = () => {
        ...
        setSelectedEssentialOptions(
            Array(essentialOptions.length).fill(newState)
        );
        setSelectedOptionalOptions(
            Array(optionalOptions.length).fill(newState)
        );
    };
                    ...
                    {essentialOptions.map((option, index) => (
                        <div key={option.value} className="flex items-center">
                            <Checkbox
                                options={[option]}
                                selectedOptions={[
                                    selectedEssentialOptions[index],
                                ]}
                                onChange={() =>
                                    handleEssentialOptionChange(index)
                                }
                    ...
                    {optionalOptions.map((option, index) => (
                        <div key={option.value} className="flex items-center">
                            <Checkbox
                                options={[option]}
                                selectedOptions={[
                                    selectedOptionalOptions[index],
                                ]}
                                onChange={() =>
                                    handleOptionalOptionsChange(index)
                                }
