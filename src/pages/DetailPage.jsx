...
import MobileEventBox from '../components/DetailComponents/MobileEventBox';
...
export default function DetailPage() {
    ...
    return (
        <>
            <div className="max-w-mw mx-auto px-6" ref={topRef}>
                {loading ? (
                    <DetailImageSkeleton />
                ) : (
                ...
                <div className="medium:flex justify-between">
                    ...
                    <div className="py-5 hidden medium:block">
                        <EventBox />
                    </div>
                </div>
