        ...
        <div className="gap-8 medium:flex medium:flex-row medium:gap-8 h-full flex flex-col p-6">
          <div className="medium:flex medium:flex-col medium:w-2/4 w-full medium:h-full ">
            <TitleBtn
              ...
              className="mb-6"
            />
            <div className="flex justify-between flex-col medium:h-[560px] p-4 border-2 border-solid border-gray-300 rounded-xl">
              {isLoading ? (
                <ScaleLoader
                  color="#2393D2"
          ...
          <div className="medium:flex medium:flex-col medium:w-2/4 w-full">
            ...
            <div className="flex h-[560px] justify-between flex-col p-4 border-2 border-solid border-gray-300 rounded-xl overflow-y-auto">
